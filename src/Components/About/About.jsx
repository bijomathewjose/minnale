...
const About = () => {
    ...
    return (
        <div className='flex about-container' id='ABOUT'>
            ...
            <div className='hidden md:flex items-center pr-[25px]'><img className=' rounded-md' src='assets/about/garden.jpg' alt='garden girl' width={"100%"} height="100%" /></div>
        </div>
    )
}
